...
/* Final version 0.03 with Sort Bug
 * Баг сортировки заклбчается в том, что в методе sortTask() класса MyListTast сортировка производится по двум
 * ключам, приоритету и влиянию. Правильно сортировка срабатывает только на третий раз, поэтому пришлось в метод
 * сортировки добавить еще один прогон сортировки, который по сути не нужен. Необходимо это исправить.
